...
# usage:
#
# perl enumerate_SJs.pl exons.fa genes.gtf >all_SJs.txt
# sort all_SJs.txt | uniq > unique_SJs.txt
#
use strict;
...
sub enumerate_SJ {
	...
	while(@exon_seqs) {
		my $exon = shift(@exon_seqs); # take out first exon in the list
